...
export default function PostCard({ post, currentUserId, currentUserName }) {
  ...
  return (
    <View style={styles.card}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.push(`/user/${post.authorId}`)} style={styles.avatar}>
      ...
      {post.videoThumbnailUrl && (
        <TouchableOpacity onPress={() => post.videoUrl && router.push(`/video?url=${encodeURIComponent(post.videoUrl)}`)}>
